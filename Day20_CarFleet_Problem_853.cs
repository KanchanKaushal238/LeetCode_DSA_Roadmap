 ...
 * 3. Push the time on the stack
 * 4. Check if time is > or equals to the top element in the stack
 * 5. If equals pop the element and do until all the elements are popped (because if they have top and next one have same time difference to reach target the fleet is 1)
 * 6. Res => Count the elements in the stack
*/
